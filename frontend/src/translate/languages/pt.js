const messages = {
  pt: {
    translations: {
      ...
      whitelabel: {
        title: "Configurações de White Label",
        primaryColorLight: "Cor Primária Modo Claro",
        primaryColorDark: "Cor Primária Modo Escuro",
        appName: "Nome do sistema",
        logoLight: "Logotipo claro",
        logoDark: "Logotipo escuro",
        favicon: "Favicon",
        backgroundLight: "Fundo da tela de login (modo claro)",
        backgroundDark: "Fundo da tela de login (modo escuro)",
        availableLanguages: "Idiomas disponíveis",
        success: "Operação atualizada com sucesso.",
        atLeastOneLanguage: "Selecione pelo menos um idioma.",

      ...
      try {
        ...
        setUser((prevState) => ({
          ...
          finalizacaoComValorVendaAtiva: data.finalizacaoComValorVendaAtiva
            ? "true"
            : "false",
          allowSeeMessagesInPendingTickets: data.allowSeeMessagesInPendingTickets === "enable" || data.allowSeeMessagesInPendingTickets === "enabled" ? "enabled" : "disabled",
  ...
  const handleSaveUser = async (values) => {
    ...
    const userData = {
      ...
      finalizacaoComValorVendaAtiva:
        values.finalizacaoComValorVendaAtiva === "true",

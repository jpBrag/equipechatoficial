...
const ScheduleModal = ({
  ...
  // ✅ MELHORIA: Status padrão baseado na origem do modal
  const getInitialStatusTicket = () => {
    if (fromMessageInput) {
      return "open"; // ✅ Se vier do MessageInput, status padrão é "open"
    }
    return "closed"; // ✅ Comportamento padrão anterior
  };
  ...
  const initialState = {
    ...
    ticketUserId: "",
    queueId: "",
    statusTicket: getInitialStatusTicket(), // ✅ Status baseado na origem
    intervalo: 1,
    valorIntervalo: 0,
